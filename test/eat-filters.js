...
var JustFilterPlugin = (function(){
	...
	var _buildCuisines = function(){
		...
		$('.c-serp-filter__list[data-ft="cuisineFilter"] ul.o-card li').each(function(index){
			...
			if( index === 0 ){
				// 'All' Cusines count
				htmlCuisines += '<li class="is-selected just-filter-separate-item"><p><span class="just-filter-tickbox"></span>All <span class="just-filter-cuisine-count">(213)</span></p></li>';
			} else {
				...
				if( highlightedCuisinesTypes.indexOf( cuisineName ) > -1 ){
					htmlCuisinesHighlighted += '<li class="just-filter-highlighted-item"><p><span class="just-filter-tickbox"></span>'+cuisineName+' <span class="just-filter-cuisine-count">('+trCount+')</span></p></li>';
				} else {
					htmlCuisinesNormal += '<li class="is-hideable" ><p><span class="just-filter-tickbox"></span>'+cuisineName+' <span class="just-filter-cuisine-count">('+trCount+')</span></p></li>';
				}
			}
		});
