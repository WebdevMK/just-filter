			...
			for( var i=0; i < _dataLayer.length; i++ ){
				...
				if( typeof _dataLayer[i]["serpData"] != 'undefined' && typeof _dataLayer[i]["serpData"]["results"] != 'undefined' ){
					...
					$(document).ready(function(){
				    	JustFilterPlugin.init(_data_obj);
				    });
				}
			}
		}
