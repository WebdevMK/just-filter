...
var JustFilterPlugin = (function(){
	...
	var _buildCuisines = function(){
		...
		// add a border separating highlighted cuisines from the rest
		if( _countCuisinesHighlighted > 0 ){
			_lastHighlightedCuisine = $('.just-filter-highlighted-item')[ $('.just-filter-highlighted-item').length - 1 ];
			$(_lastHighlightedCuisine).addClass('just-filter-separate-item');
		} else {
			// hide cuisine controls
			$('.just-filter-cuisines-control').hide();
		}
