...
chrome.storage.local.get(['isJustEatExtensionOn'], function(result) {
	...
	if( isJustEatExtensionOn === 'true' ){
		...
		console.log("--- JustEat Extension is off");
	}	
});